...
def make_subset(samples, transforms, prefixes=[], suffixes=[]):
    ...
    subset : :py:class:`deepdraw.common.data.utils.SampleListDetectionDataset`
...
def augment_subset(s, rotation_before=False):
    ...
    s : deepdraw.common.data.utils.SampleListDetectionDataset
...
def make_dataset(subsets, transforms):
    ...
    :py:class:`deepdraw.common.data.utils.SampleListDetectionDataset` to these
    ...
    * ``train``: Wraps the ``test`` subset, **without** data augmentation
    ...
    dataset : dict
        ...
        string names to
        :py:class:`deepdraw.common.data.utils.SampleListDetectionDataset`'s.
    """
