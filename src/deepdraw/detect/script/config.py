...
\b
  1. Lists all configuration resources (type: detect.config) installed:
...
def list(verbose) -> None:
    ...
    entry_points = _retrieve_entry_points("detect.config")
...
\b
  1. Describes the Montgomery dataset configuration:
     ...
     .. code:: sh
        ...
        detect config describe montgomery
...
\b
  2. Describes the Montgomery dataset configuration and lists its
     ...
     .. code:: sh
        ...
        detect config describe montgomery -v
...
\b
  1. Makes a copy of one of the stock configuration files locally, so it can be
     ...
     .. code:: sh
        ...
        $ detect config copy montgomery -vvv newdataset.py
