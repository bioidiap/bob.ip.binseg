...
.. list-table::
   ...
   * - Dataset
     ...
     - 0.55M
     - 25.8M
   * - :py:mod:`drive <deepdraw.binseg.configs.datasets.drive.covd>`
     - 0.788 (0.021)
   ...
   * - :py:mod:`stare <deepdraw.binseg.configs.datasets.stare.covd>`
     - 0.759 (0.028)
   ...
   * - :py:mod:`chasedb1 <deepdraw.binseg.configs.datasets.chasedb1.covd>`
     - 0.768 (0.023)
   ...
   * - :py:mod:`hrf <deepdraw.binseg.configs.datasets.hrf.covd>`
     -
     - `0.742 (0.049) <covd_driu_hrf_>`_
     - `0.719 (0.047) <covd_hed_hrf_>`_
     - `0.735 (0.045) <covd_m2unet_hrf_>`_
     - `0.746 (0.046) <covd_unet_hrf_>`_
   * - :py:mod:`iostar-vessel <deepdraw.binseg.configs.datasets.iostar.covd>`
     -
...
* The following table describes recommended batch sizes for 24Gb of RAM GPU
  ...
  .. list-table::
    ...
    * - **Models / Datasets**
      - :py:mod:`drive-covd <deepdraw.binseg.configs.datasets.drive.covd>`
      - :py:mod:`stare-covd <deepdraw.binseg.configs.datasets.stare.covd>`
      - :py:mod:`chasedb1-covd <deepdraw.binseg.configs.datasets.chasedb1.covd>`
      - :py:mod:`iostar-vessel-covd <deepdraw.binseg.configs.datasets.iostar.covd>`
      - :py:mod:`hrf-covd <deepdraw.binseg.configs.datasets.hrf.covd>`
    * - :py:mod:`driu <deepdraw.binseg.configs.models.driu>` / :py:mod:`driu-bn <deepdraw.binseg.configs.models.driu_bn>`
      - 4
      - 4
      - 2
      - 2
