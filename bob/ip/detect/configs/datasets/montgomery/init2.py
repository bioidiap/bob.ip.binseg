...
def _maker_augmented(protocol, ref_data):
    ...
    from ....data.transforms_new import ResizeMasks as _resizemasks
    from ....data.transforms_new import CenterMasks as _centermasks
    ...
    return mk_aug_subset(
        ...
        all_transforms=[_shrinkintosq(), _centermasks(),
                        _resizemasks(ref_data), _resize((256, 256))],
        train_transforms=[
            _compose(
                [
                    _shrinkintosq(),
                    _centermasks(),
                    _resizemasks(ref_data),
                    _resize((256, 256)),
